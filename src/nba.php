    ...
    <nav class="navbar navbar-expand-sm  text-white bg-dark navbar-dark py-2 fixed-top">
      ...
      <div class="collapse navbar-collapse pt-3" id="navbarnNav">
           <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item">
                 <a class="nav-link active" href="nba.php">NBA</a>
             </li>
             <li class="nav-item">
...
<section class="mainshowcase"  id="basketballsection">
        <div class="row">
          <div class = "col-lg-12 pt-5">
              <div class = "d-flex justify-content-center ">
                  <img class="d-block img-fluid border border-danger " src="images/lebronlakers.jpg"
                  alt="">
            </div>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 p-lg-5 p-sm-2">
          <h2 class="display-5  text-center page-title my-4 font-weight-bold">RAMS CONTRACT DEAL WITH TODD GURLEY 60$ MILLION</h1>
        ...
        Wilson, are the players who actually win games.
                 ...
                 <div class="video d-flex justify-content-center">
                         <iframe class="videolink my-5" width="750" height="450"
                          src="https://www.youtube.com/embed/7L3ID5dX71c">
                        </iframe>
                  </div>
